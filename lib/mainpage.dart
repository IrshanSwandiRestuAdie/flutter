                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 18,
                      color: Colors.green[800], // Warna hijau
                    ),
                  ),
      ...
      body: cart.items.isEmpty
          ...
          : Column(
              children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      iconSize: 20,
                                      onPressed: () {
                                        cart.decreaseItemQuantity(cartItem.product.id);
                                      },
                                    ),
                                    Text(
                                      '${cartItem.quantity}',
                                    ...
                                    IconButton(
                                      ...
                                      iconSize: 20,
                                      onPressed: () {
                                        cart.increaseItemQuantity(cartItem.product.id);
                                      },
                                    ),
                                  ],
                                ),
                ...
                // Bagian total dan checkout (tetap sama seperti sebelumnya)
                Card(
